...
describe('calculateDiscount', () => {
  ...
  test('should apply 20% discount when cart has 1 sandwich and 2 extras', () => {
    const cartItems = [
  ...
  test('should apply 15% discount when cart has 1 sandwich and 1 extra', () => {
    const cartItems = [
      { id: 1, name: 'Burger', price: 5.00, category: 'sandwich' },
      { id: 4, name: 'Fries', price: 2.00, category: 'extra' }
    ];
  ...
  test('should apply 10% discount when cart has 2 extras and no sandwich', () => {
    const cartItems = [
      { id: 4, name: 'Fries', price: 2.00, category: 'extra' },
      { id: 5, name: 'Soft Drink', price: 2.50, category: 'extra' }
    ];
